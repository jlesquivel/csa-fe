...
Public Class rptMensajeReceptor
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ConsoleApp1.rptMensajeReceptor.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptMensajeReceptor
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptMensajeReceptor = New rptMensajeReceptor()
        rpt.Site = Me.Site
        Return rpt
    End Function
